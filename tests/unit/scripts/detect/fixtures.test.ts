...
describe("detection fixtures — real detector over collected sites", () => {
  ...
  it("framer/pixwave exposes framerSiteId in platformHints", async () => {
    const fixture = fixtures.find((entry) => entry.group === "framer" && entry.name === "pixwave");
    expect(fixture, "framer/pixwave fixture must exist").toBeDefined();
